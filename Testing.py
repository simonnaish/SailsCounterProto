...
# databaseHandler.sendDailyMovement()
# databaseHandler.addSail('FR36201')
# databaseHandler.sendDailyMovement()
#databaseHandler.sendMovementOfDay('2020-02-11')
databaseHandler.sendMovementInDays('2020-02-11', '2020-02-16')
#databaseHandler.sendMovementOfToday()
